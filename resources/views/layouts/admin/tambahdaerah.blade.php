      ...
      <div class="row">
        <div class="col-lg-12 mb-3 mb-lg-0">      
          ...
          <div class="card">
            ...
            <!-- Body -->
            <div class="card-body">
            <form action="{{ route('daerah.prosestambah')}}" method="post" enctype="multipart/form-data">
              @csrf		              
				<div class="row">
				  <label class="col-sm-3 col-form-label">Nama Daerah</label>
				  <div class="col-sm-9">
					<input type="text" class="form-control" required name="nama_daerah">
				  </div>
				</div>
				<br>
				<div class="row">
				...
				<div class="row">
				  ...
				  <div class="col-sm-9">
					<textarea name="penjelasan_daerah"></textarea>
				  </div>
				</div>
				<br>				
				<div class="row">
