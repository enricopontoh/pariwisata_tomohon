@include('layouts.component.header')
    ...
    <div class="row justify-content-between align-items-center flex-grow-1">
      <div class="col-12 col-md">
        <div class="d-flex justify-content-between align-items-center">
          <h5 class="card-header-title">Kategori</h5>
        </div>
      </div>
  ...
  <div class="table-responsive datatable-custom">
    <table id="datatbleWithFilter" class="js-datatable table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
      ...
      <td>
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modaledit{{ $tampilkategori_artikel->id }}" class="btn btn-primary btn-sm">
            ...
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampilkategori_artikel->id }}" class="btn btn-danger btn-sm">
                        <i class="bi-trash-fill me-1"></i> Hapus 
                                ...
                                <form action="{{ route('kategori.prosesupdate', $tampilkategori_artikel->id) }}" method="post">
              @csrf		              
			   @method('PUT')  
																				<!-- Button trigger modal -->
																				<!-- Modal -->
																				<div class="modal fade" id="modaledit{{ $tampilkategori_artikel->id }}"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
																					<div class="modal-dialog">
																						<div class="modal-content">
																							<div class="modal-header">
																								<h5 class="modal-title mt-0" id="myModalLabel">Edit Data {{ $tampilkategori_artikel->nama_kategori }}?</h5>
																								<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
																								</button>
																							</div>
																							<div class="modal-body">
                                          <div class="row">
                                            <label class="col-sm-3 col-form-label">Nama Kategori</label>
                                            <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $tampilkategori_artikel->nama_kategori }}" name="nama_kategori">
                                            </div>
                                          </div>
                                          <br>
                                          <div class="row">
                                            <label class="col-sm-3 col-form-label">Hastag Kategori</label>
                                            <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $tampilkategori_artikel->hastag_kategori }}" name="hastag_kategori">
                                            </div>
                                          </div>
                                          <br>
																							</div>
