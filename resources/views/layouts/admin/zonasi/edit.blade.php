      ...
      <div class="row">
        <div class="col-lg-8 mb-3 mb-lg-0">      
          ...
          <div class="card">
            ...
            <!-- Body -->
            <div class="card-body">
                <form action="{{ route('zonasi.update',$data->id)}}" method="post">
                    @csrf
                    @method('put')
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" required name="id_daerah"
                                ...
                                @foreach ($daerah as $d)
                                    @php $selected="";@endphp
                                    @if($d->id == $data->id_daerah)
                                        @php $selected="selected";@endphp
                                    @endif
                                    <option {{$selected}} value="{{ $d->id }}">{{$d->nama_daerah}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" required name="id_wisata" id="id_wisata" onchange="javascript:changeColorAndPoint(this.value)">
                                ...
                                @foreach ($wisata as $p)
                                    <option @if($p->id==$data->id_wisata) selected @endif value="{{ $p->id }}">{{$p->nama_wisata}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
